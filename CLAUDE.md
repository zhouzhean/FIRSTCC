...
| `Francis Investment/` | A-stock quant system v3.4.5 + report engine → see `Francis Investment/CLAUDE.md` |
...
- **Version**: v3.4.5 — Data bus unified: pipeline writes market_snapshot_latest.json, per-index freshness tracking
