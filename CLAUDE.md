...
| `Francis Investment/` | A-stock quant system v3.4.9.7 + report engine → see `Francis Investment/CLAUDE.md` |
...
- **Version**: v3.4.9.8 — P1.6 Canonical Cohort Fix + H1 REJECTED_RESEARCH
